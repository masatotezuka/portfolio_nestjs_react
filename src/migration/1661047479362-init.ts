...
export class init1661047479362 implements MigrationInterface {
    name = 'init1661047479362'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_machines" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "userId" integer, "machineId" integer, CONSTRAINT "PK_f16d4070d0c9b64ed9db4c86e3b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "machines" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "purchasedAt" date, "deletedAt" TIMESTAMP WITH TIME ZONE, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "machineCategoryId" integer, CONSTRAINT "PK_7b0817c674bb984650c5274e713" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "machine_histories" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" integer, "machineId" integer, "usageStatusId" integer, CONSTRAINT "PK_6e68d67930a4dd55255acda15e1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_license" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "userId" integer, "licenseId" integer, CONSTRAINT "PK_f9fdeafeac79f9c3ef6acbca1f2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "license_histories" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" integer, "licenseId" integer, "usageStatusId" integer, CONSTRAINT "PK_f7e3f66b3855d8604968753d1ed" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "machine_histories" ADD CONSTRAINT "FK_22af066881920bfc74df5cbae20" FOREIGN KEY ("usageStatusId") REFERENCES "usage_statuses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "license_histories" ADD CONSTRAINT "FK_d83cca0b3d519900c72f5e7e84c" FOREIGN KEY ("usageStatusId") REFERENCES "usage_statuses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "license_histories" DROP CONSTRAINT "FK_d83cca0b3d519900c72f5e7e84c"`);
        ...
        await queryRunner.query(`ALTER TABLE "machine_histories" DROP CONSTRAINT "FK_22af066881920bfc74df5cbae20"`);
