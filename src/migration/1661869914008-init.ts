...
export class init1661869914008 implements MigrationInterface {
    name = 'init1661869914008'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "machines" ("id" SERIAL NOT NULL, "symbol" character varying NOT NULL, "category" character varying NOT NULL, "name" character varying NOT NULL, "purchasedAt" date, "deletedAt" TIMESTAMP WITH TIME ZONE, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_7b0817c674bb984650c5274e713" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "machine_histories" ("id" SERIAL NOT NULL, "usageStatus" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" integer, "machineId" integer, CONSTRAINT "PK_6e68d67930a4dd55255acda15e1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "license_histories" ("id" SERIAL NOT NULL, "usageStatus" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" integer, "licenseId" integer, CONSTRAINT "PK_f7e3f66b3855d8604968753d1ed" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "licenses" ("id" SERIAL NOT NULL, "symbol" character varying NOT NULL, "name" character varying NOT NULL, "purchasedAt" date, "expiredAt" date, "deletedAt" TIMESTAMP WITH TIME ZONE, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_da5021501ce80efa03de6f40086" PRIMARY KEY ("id"))`);
